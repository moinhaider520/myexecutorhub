          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <tr>
                ...
                <form action="{{ route('customer.pictures_and_videos.destroy', $document->id) }}"
...
<script>
  $(document).ready(function () {
    ...
    $('#addDocumentForm').on('submit', function (e) {
      ...
      $.ajax({
        url: "{{ route('customer.pictures_and_videos.store') }}",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
    ...
    $('#editDocumentForm').on('submit', function (e) {
      ...
      $.ajax({
        url: "{{ url('customer/pictures_and_videos/update') }}" + '/' + documentId, // Include the ID in the URL
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
