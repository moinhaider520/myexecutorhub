                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <form action="{{ route('customer.pensions.destroy', $pension->id) }}" method="POST" style="display:inline;">
                              @csrf
                              @method('DELETE')
...
<script>
  $(document).ready(function() {
    $('#savePension').on('click', function() {
      $.ajax({
        type: 'POST',
        url: "{{ route('customer.pensions.store') }}",
    ...
    $('#updatePension').on('click', function() {
      ...
      $.ajax({
        type: 'POST',
        url: '/customer/pension/update/' + id,
