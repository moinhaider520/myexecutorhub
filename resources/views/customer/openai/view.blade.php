...
@section('content')
  <div class="page-body">
    ...
    <div class="row g-0">
      ...
      <div class="col-md-12">
        <h3>Disclaimer</h3>
        <p>The responses provided by Executor Hub AI are not 100% correct. The information provided is backed up by
        other resources. It is always a good idea to verify information from multiple sources before making
      ...
      @endforeach
        ...
        <form id="form" class="msger-inputarea">
          <input class="form-control" style="width:100%;" type="text" id="message" name="message"
