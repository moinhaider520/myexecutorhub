                    ...
                    <table class="display dataTable no-footer" id="basic-1" role="grid" aria-describedby="basic-1_info">
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <form action="{{ route('customer.memorandum_wishes.destroy', $document->id) }}" method="POST"
...
<script>
  $(document).ready(function() {
    ...
    $('#addDocumentForm').on('submit', function(e) {
      ...
      $.ajax({
        url: "{{ route('customer.memorandum_wishes.store') }}",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
    ...
    $('.edit-button').on('click', function() {
      ...
      $.get(`/customer/memorandum_wishes/${id}/media`, function(media) {
        if (media.length > 0) {
    ...
    $(document).on('click', '.delete-media', function() {
      ...
      $.ajax({
        url: `/customer/memorandum_wishes/media/${mediaId}`,
        type: 'DELETE',
        data: {
          _token: '{{ csrf_token() }}'
        },
  ...
  $('#editDocumentForm').on('submit', function(e) {
    ...
    $.ajax({
      url: "{{ url('customer/memorandum_wishes/update') }}" + '/' + documentId, // Include the ID in the URL
      type: "POST",
      data: formData,
      contentType: false,
      processData: false,
