        ...
        <div class="bg-white shadow-lg rounded-lg p-6 sm:p-10 border border-gray-200">
            ...
            <div class="flex flex-col items-center justify-center min-h-[500px] text-center">
                ...
                <div class="mb-6">
                    ...
                    <svg class="mx-auto w-32 h-32 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <rect x="2" y="7" width="20" height="15" rx="2" ry="2" fill="white" stroke="currentColor"/>
                        ...
                        <circle cx="12" cy="17" r="1" />
                        <path stroke="black" d="M3 7h18a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V8a1 1 0 0 1 1-1z" fill="white" stroke-width="1.5"/>
                ...
                <p class="text-gray-600 mb-8 max-w-md">
                    Will has been created by the recipe using Workato FileStorage will appear here. You can also manually upload file and create directory here.
                </p>

                {{-- Buttons --}}
                <div class="flex space-x-4">
                    <a href="#" class="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150 ease-in-out">
                        Upload file
                    </a>
                    {{-- The link to your "Create Will Manually" page --}}
                    <a href="{{ route('customer.will_generator.about_you') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 text-base font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition duration-150 ease-in-out">
