                        ...
                        @foreach($pictures as $picture)
                          <tr>
                            ...
                            <td>
                              ...
                              <form action="{{ route('partner.pictures.destroy', $picture->id) }}"
...
<script>
  $(document).ready(function () {
    ...
    $('#addPictureForm').on('submit', function (e) {
      ...
      $.ajax({
        url: "{{ route('partner.pictures.store') }}",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
    ...
    $('#editPictureForm').on('submit', function (e) {
      ...
      $.ajax({
        url: "{{ url('partner/pictures/update') }}" + '/' + pictureId, // Include the ID in the URL
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
