...
<div class="page-body">
    <div class="container-fluid">
        <div class="edit-profile">
            <div class="row">
                <div class="col-xl-12">
                    <form action="{{ route('partner.update_profile') }}" method="POST" class="card" id="edit-profile">
                        @csrf
                    ...
                    <form action="{{ route('partner.update_profile_image') }}" method="POST" class="card" id="edit-image" enctype="multipart/form-data">
                        @csrf
                        <div class="card-header">
                    ...
                    <form action="{{ route('partner.update_password') }}" method="POST" class="card" id="edit-password">
                        @csrf
                        <div class="card-header">
