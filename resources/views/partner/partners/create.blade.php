                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('partner.partners.store') }}" method="POST">
                                        @csrf
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="postal_code" id="postal_code" class="form-control"
                                                value="{{ old('postal_code') }}" placeholder="Enter postal code" required>
                                            @error('postal_code')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <select class="form-control" name="profession" required>
                                                ...
                                                <option value="Life insurance specialists">Life insurance specialists
                                                </option>
