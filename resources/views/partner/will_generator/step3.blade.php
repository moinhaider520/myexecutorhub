            ...
            <div class="card">
                ...
                <div class="card-body basic-wizard important-validation">
                    <form id="msform" class="needs-validation" novalidate action="{{ route('partner.will_generator.store_step3') }}" method="POST">
                        ...
                        <div class="row g-4">
                            <div id="partnerContainer" class="col-sm-6 form-section">
                                ...
                                <div class="mt-4">
                                    <button type="button" class="w-full py-3 px-4 bg-white border-2 border-dashed border-gray-300 rounded-lg text-gray-600 hover:border-blue-500 hover:text-blue-700 transition-all duration-200 flex items-center justify-center" data-toggle="modal" data-target="#addExecutorModal">
                        ...
                        <div class="wizard-footer d-flex gap-2 justify-content-end mt-4">
                            <button class="btn badge-light-primary" id="backbtn" onclick="history.back()" disabled>Back</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editExecutorForm">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" id="deletePersonButton">Remove Partner</button>
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        maritalStatusSelect.addEventListener('change', togglePartnerSection);
