      ...
      <div class="row widget-grid">
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              <div id="dummy-text">
                <b>You are ready to start.</b> It should take 10-20 minutes. You must complete your session in one go.
                If you pause or cancel your session, you will have to start again from Device Check.
              </div>
              <p>You will be asked for the following things when recording a Will, so make sure to prepare these at the
                time of recording:</p>
              <ol>
