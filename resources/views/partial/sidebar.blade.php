<div class="sidebar-wrapper" data-layout="stroke-svg">
    <div>
        ...
        <div class="logo-icon-wrapper">
            <a
                href="{{ route(auth()->user()->hasRole('admin') ? 'admin.dashboard' : (auth()->user()->hasRole('customer') ? 'customer.dashboard' : (auth()->user()->hasRole('partner') ? 'partner.dashboard' : (auth()->user()->hasRole('executor') ? 'executor.dashboard' : 'dashboard')))) }}">
                <img class="img-fluid" src="{{ asset('assets/images/favicon.ico') }}" style="width:20px;"
                    alt="">
            </a>
        </div>
                ...
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    <li class="sidebar-list">
                        ...
                        <ul class="sidebar-submenu">
                            ...
                            <li><a href="{{ route('partner.properties.view') }}">Property <span
                            ...
                            <li><a href="{{ route('partner.other_type_of_assets.view') }}">Other Type of Assets</a>
                            </li>
                    ...
                    <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title" href="{{ route('partner.digital_assets.view') }}">
                            <svg class="stroke-icon">
                                <use href="{{ asset('assets/svg/icon-sprite.svg#stroke-board') }}"></use>
                            </svg>
                            <svg class="fill-icon">
                    ...
                    <li class="sidebar-list">
                        ...
                        <ul class="sidebar-submenu">
                            <li><a href="{{ route('partner.memorandum_wishes.view') }}">Manage Memorandum Wishes</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="sidebar-list">
                        ...
                        <ul class="sidebar-submenu">
                            <li><a href="{{ route('partner.useful_contacts.index') }}">View</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="sidebar-list">
                        ...
                        <ul class="sidebar-submenu">
                            ...
                            <li>
                                @if ($will_user_info)
                                <a
                                    href="{{ route('customer.will_generator.create', $will_user_info->id) }}">Edit
                                    Will</a>
                                @else
                    ...
                    @canany(['view bank accounts', 'view investment accounts', 'view properties', 'view personal
                    chattels', 'view business interests', 'view insurance policies', 'view debt and liabilities', 'view
                    digital assets', 'view intellectual properties', 'view other assets', 'view other type of assets',
                    'view pension', 'view funeral plan', 'view foreign assets', 'view pictures', 'view videos'])
