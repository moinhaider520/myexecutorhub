...
<body>
    ...
    <div id="page" class="page font--jakarta">
        ...
        <section id="commission-calculator" class="pb-50 inner-page-hero contacts-section division">
            <div class="container">
                <h2 class="s-46 w-700 text-center">Commission Calculator</h2>
                <form id="calculatorForm">
                    ...
                    <div class="section">
                        ...
                        <div class="results-section">
                            ...
                            <div class="info-note">
                                <strong>Note:</strong> Override earnings are calculated from your recruited partners'
                                sales.
                                You earn 20% of each sale made by partners you recruit.
                            </div>
                        </div>
                    </div>
