                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <form action="{{ route('executor.intellectual_properties.destroy', $property->id) }}" method="POST" style="display:inline;">
                              @csrf
                              @method('DELETE')
...
<script>
  ...
  $('#saveIntellectualProperty').on('click', function () {
    ...
    $.ajax({
      type: 'POST',
      url: '{{ route("executor.intellectual_properties.store") }}',
      data: formData,
  ...
  $('#updateIntellectualProperty').on('click', function () {
    ...
    $.ajax({
      type: 'POST',
      url: '/executor/intellectual_properties/update/' + id,
      data: formData,
      success: function (response) {
        // Reset form fields
  ...
  $('#propertyType').change(function () {
    ...
    $('#saveCustomPropertyType').on('click', function () {
      ...
      if (customPropertyType) {
        $.ajax({
          type: 'POST',
          url: "{{ route('executor.intellectual_properties.save_custom_type') }}",
          data: {
            _token: "{{ csrf_token() }}",
