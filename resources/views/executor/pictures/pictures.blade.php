                          ...
                          @foreach($pictures as $picture)
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                <form action="{{ route('executor.pictures.destroy', $picture->id) }}" method="POST"
  ...
  <script>
    $(document).ready(function () {
      ...
      $('#addPictureForm').on('submit', function (e) {
        ...
        $.ajax({
          url: "{{ route('executor.pictures.store') }}",
          type: "POST",
          data: formData,
          contentType: false,
          processData: false,
      ...
      $('#editPictureForm').on('submit', function (e) {
        ...
        $.ajax({
          url: "{{ url('executor/pictures/update') }}" + '/' + pictureId, // Include the ID in the URL
          type: "POST",
          data: formData,
          contentType: false,
          processData: false,
