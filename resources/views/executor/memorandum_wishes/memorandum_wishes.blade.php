                    ...
                    <table class="display dataTable no-footer" id="basic-1" role="grid" aria-describedby="basic-1_info">
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <form action="{{ route('executor.memorandum_wishes.destroy', $document->id) }}" method="POST"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addDocumentModalLabel">Add Memorandum of Wish</h5>
      </div>
...
<script>
  $(document).ready(function() {
    ...
    $('#addDocumentForm').on('submit', function(e) {
      ...
      $.ajax({
        url: "{{ route('executor.memorandum_wishes.store') }}",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
    ...
    $('.edit-button').on('click', function() {
      ...
      $.get(`/executor/memorandum_wishes/${id}/media`, function(media) {
        if (media.length > 0) {
    ...
    $(document).on('click', '.delete-media', function() {
      ...
      $.ajax({
        url: `/executor/memorandum_wishes/media/${mediaId}`,
        type: 'DELETE',
        data: {
          _token: '{{ csrf_token() }}'
        },
  ...
  $('#editDocumentForm').on('submit', function(e) {
    ...
    $.ajax({
      url: "{{ url('executor/memorandum_wishes/update') }}" + '/' + documentId, // Include the ID in the URL
      type: "POST",
      data: formData,
      contentType: false,
      processData: false,
