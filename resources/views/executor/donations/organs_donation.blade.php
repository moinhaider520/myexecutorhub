          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <tr>
                ...
                <form action="{{ route('executor.organs_donation.destroy', $donation->id) }}" method="POST"
...
<script>
  $(document).ready(function () {
    $('#saveBankAccount').on('click', function () {
      $.ajax({
        type: 'POST',
        url: "{{ route('executor.organs_donation.store') }}",
    ...
    $('#updateBankAccount').on('click', function () {
      ...
      $.ajax({
        type: 'POST',
        url: '/executor/organs_donation/update/' + id,
