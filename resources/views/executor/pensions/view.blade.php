                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style="white-space: nowrap;">
                            ...
                            <form action="{{ route('executor.pensions.destroy', $pension->id) }}" method="POST" style="display:inline;">
                              @csrf
                              @method('DELETE')
...
<script>
  $(document).ready(function() {
    $('#savePension').on('click', function() {
      $.ajax({
        type: 'POST',
        url: "{{ route('executor.pensions.store') }}",
    ...
    $('#updatePension').on('click', function() {
      ...
      $.ajax({
        type: 'POST',
        url: '/executor/pension/update/' + id,
