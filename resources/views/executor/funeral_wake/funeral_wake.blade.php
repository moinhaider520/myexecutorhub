                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <form action="{{ route('executor.funeral_wake.destroy', $funeralwake->id) }}" method="POST" style="display:inline;">
                              @csrf
                              @method('DELETE')
...
<script>
  $(document).ready(function() {
    ...
    $('#addFuneralWakeForm').on('submit', function(e) {
      ...
      $.ajax({
        url: "{{ route('executor.funeral_wake.store') }}",
        method: 'POST',
        data: $(this).serialize(),
    ...
    $('#editFuneralWakeForm').on('submit', function(e) {
      ...
      $.ajax({
        url: "/executor/funeral_wake/update/" + id,
        method: 'POST',
        data: $(this).serialize(),
        success: function(response) {
          if (response.success) {
