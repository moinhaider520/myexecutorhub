...
<head>
    ...
    <!-- SITE TITLE -->
    <title>Case Study: Cutting Delays From Banks, HMRC, DWP & Other Organisations - Executor Hub</title>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-10">
                        ...
                        <div class="inner-page-title">
                            <h2 class="s-52 w-700">Case Study 5: Cutting Delays From Banks, HMRC, DWP & Other Organisations</h2>
                            <p class="p-lg">How Executor Hub eliminates the administrative drag executors face.</p>
                        </div>
                        ...
                        <div class="txt-block legal-info">
                            ...
                            <p>Executors for a modest estate spent over three months waiting on responses from:</p>
                            
                            <ul class="simple-list">
                                <li class="list-item"><p>Two banks</p></li>
                                <li class="list-item"><p>A pension provider</p></li>
                                <li class="list-item"><p>HMRC</p></li>
                                <li class="list-item"><p>The DWP</p></li>
                                <li class="list-item"><p>Utilities</p></li>
                                <li class="list-item"><p>Insurance providers</p></li>
                            </ul>

                            <p>Most delays were caused by:</p>
                            <ul class="simple-list">
                                <li class="list-item"><p>Sending the wrong forms</p></li>
                                <li class="list-item"><p>Missing information</p></li>
                                <li class="list-item"><p>Being asked to provide the same documents repeatedly</p></li>
                                <li class="list-item"><p>Difficulty proving authority</p></li>
                                <li class="list-item"><p>Letters being returned because they were sent to the wrong address</p></li>
                            </ul>

                            <p>The executors described the process as "endless chasing".</p>

                            <!-- How Executor Hub Would Have Helped -->
                            <h4 class="s-30 w-700"><span>How Executor Hub Would Have Helped</span></h4>
                            <p>Executor Hub offers:</p>
                            
                            <ul class="simple-list">
                                <li class="list-item"><p>Auto-generated letters and emails with the correct wording for each organisation</p></li>
                                <li class="list-item"><p>Templates for DVLA, council tax, banks, HMRC, pension providers, utilities, and more</p></li>
                                <li class="list-item"><p>One-click "send notification" workflows</p></li>
                                <li class="list-item"><p>A secure document vault so the Grant can be uploaded and attached instantly</p></li>
                                <li class="list-item"><p>A progress tracker showing what each organisation has received</p></li>
                            </ul>

                            <!-- Outcome if Executor Hub Was Used -->
                            <h4 class="s-30 w-700"><span>Outcome if Executor Hub Was Used</span></h4>
                            <p>Instead of three months of repeated admin, the executors could have resolved notifications in days, not weeks, saving:</p>
                            <ul class="simple-list">
                                <li class="list-item"><p>✔ Time</p></li>
                                <li class="list-item"><p>✔ Stress</p></li>
                                <li class="list-item"><p>✔ Repetition</p></li>
                                <li class="list-item"><p>✔ Delays in finalising probate</p></li>
                            </ul>

                            <p><strong>Executor Hub dramatically reduces friction by giving executors the tools professionals use — in one place.</strong></p>
