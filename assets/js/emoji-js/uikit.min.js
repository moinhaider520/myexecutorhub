...
(function(Gt, ve) {
    typeof exports == "object" && typeof module != "undefined" ? module.exports = ve() : typeof define == "function" && define.amd ? define("uikit", ve) : (Gt = typeof globalThis != "undefined" ? globalThis : Gt || self, Gt.UIkit = ve())
})(this, function() {
    "use strict";
    ...
    function Ft(t) {
        return ge(t) ? t : (t = J(t), t ? (Kt(t) ? t : t.ownerDocument).defaultView : window)
    }
    ...
    function pt(t, e, i) {
        return e === void 0 && (e = 0), i === void 0 && (i = 1), Math.min(Math.max(Nt(t) || 0, e), i)
    }
    ...
    var Qt = {
        ...
        contain: function(t, e) {
            var i = this;
            return t = S({}, t), nt(t, function(n, r) {
                return t = t[r] > e[r] ? i.ratio(t, r, e[r]) : t
            }), t
        },
        cover: function(t, e) {
            var i = this;
            return t = this.contain(t, e), nt(t, function(n, r) {
                return t = t[r] < e[r] ? i.ratio(t, r, e[r]) : t
            }), t
        }
    };
    ...
    function Ut(t, e, i, n) {
        ...
        var r = e.length;
        return t = Ct(t) ? Nt(t) : t === "next" ? i + 1 : t === "previous" ? i - 1 : e.indexOf(J(t)), n ? pt(t, 0, r - 1) : (t %= r, t < 0 ? t + r : t)
    }
    ...
    function M(t, e, i) {
        ...
        C(t).forEach(function(r) {
            ct(i) && (i = i.call(r, M(r, e))), i === null ? Pi(r, e) : r.setAttribute(e, i)
        })
    }
    ...
    function Pi(t, e) {
        t = C(t), e.split(" ").forEach(function(i) {
    ...
    function ot(t, e) {
        return vt(e, ">") && (e = e.slice(1)), Ot(t) ? es.call(t, e) : C(t).map(function(i) {
            return ot(i, e)
        }).filter(Boolean)
    }
    ...
    function vn(t, e) {
        return e === void 0 && (e = document), H(t) && pn(t) || Kt(e) ? e : e.ownerDocument
    }
    ...
    function gn(t, e, i) {
        ...
        t = t.replace(ns, "$1 *"), pn(t) && (t = ss(t).map(function(n) {
            var r = e;
            if (n[0] === "!") {
    ...
    function A() {
        ...
        var i = mn(t),
            ...
            o = i[3],
            a = i[4];
        return n = Ge(n), o.length > 1 && (o = hs(o)), a && a.self && (o = cs(o)), s && (o = us(s, o)), a = wn(a), r.split(" ").forEach(function(u) {
    ...
    function Wt(t, e, i, n) {
        n === void 0 && (n = !1), n = wn(n), t = Ge(t), e.split(" ").forEach(function(r) {
    ...
    function ps(t, e) {
        return t = $(t), t.hasChildNodes() ? Qe(e, function(i) {
            return t.insertBefore(i, t.firstChild)
        }) : K(t, e)
    }

    function K(t, e) {
        return t = $(t), Qe(e, function(i) {
    ...
    function Qe(t, e) {
        return t = H(t) ? ue(t) : t, t ? "length" in t ? C(t).map(e) : e(t) : null
    }
    ...
    function ue(t) {
        ...
        return ms.test(t) ? i.insertAdjacentHTML("beforeend", t.trim()) : i.textContent = t, i.childNodes.length > 1 ? C(i.childNodes) : i.firstChild
    }
    ...
    var ii = {
            ...
            get: function(t) {
                var e = document.createElement("_"),
                    i = e.classList;
                return i.add("a", "b"), i.toggle("c", !1), ii = {
    ...
    function d(t, e, i, n) {
        return n === void 0 && (n = ""), C(t).map(function(r) {
            if (H(e)) {
            ...
            } else Tt(e) && (n = i, nt(e, function(o, a) {
                return d(r, a, o, n)
            }));
            return r
        })[0]
    ...
    function En(t, e, i, n) {
        return i === void 0 && (i = 400), n === void 0 && (n = "linear"), b.all(C(t).map(function(r) {
            return new b(function(s, o) {
                ...
                X(r, "transitionend transitioncanceled", function(f) {
                    var h = f.type;
                    clearTimeout(c), N(r, "uk-transition"), d(r, {
                        transitionProperty: "",
                        transitionDuration: "",
    ...
    function Wi(t, e, i, n, r) {
        return i === void 0 && (i = 200), b.all(C(t).map(function(s) {
            return new b(function(o, a) {
                ...
                X(s, "animationend animationcanceled", function(c) {
                    var f = c.type;
                    clearTimeout(u), f === "animationcanceled" ? a() : o(s), d(s, "animationDuration", ""), ei(s, _e + "\\S*")
                }, {
                    self: !0
                }), d(s, "animationDuration", i + "ms"), y(s, e, _e + (r ? "leave" : "enter")), vt(e, _e) && (n && y(s, "uk-transform-origin-" + n), r && y(s, _e + "reverse"))
            })
        }))
    }
    ...
    function B(t, e) {
        ...
        if (t) {
            ...
            for (var a in zt)
                for (var u in zt[a]) i[zt[a][u]] += o[a]
        }
        if (!e) return i;
        var c = d(t, "position");
    ...
    function ri(t) {
        ...
        if (Ot(c)) {
            var f = B(c);
            i -= f.top + k(d(c, "borderTopWidth")), n -= f.left + k(d(c, "borderLeftWidth"))
        }
        return {
    ...
    function In(t) {
        ...
        return function(i, n) {
            if (Z(n)) {
                ...
                return i = J(i), n = d(i, t), n = n === "auto" ? i["offset" + e] : k(n) || 0, n - Rt(i, t)
            } else return d(i, t, !n && n !== 0 ? "" : +n + Rt(i, t) + "px")
        }
    }

    function Rt(t, e, i) {
        return i === void 0 && (i = "border-box"), d(t, "boxSizing") === i ? zt[e].map(We).reduce(function(n, r) {
    ...
    function yt(t, e, i) {
        return e === void 0 && (e = "width"), i === void 0 && (i = window), Ct(t) ? +t : gt(t, "vh") ? Ri(q(Ft(i)), t) : gt(t, "vw") ? Ri(Pe(Ft(i)), t) : gt(t, "%") ? Ri(I(i)[e], t) : k(t)
    }
    ...
    function ji(t) {
        t === void 0 && (t = 1), _n(F.reads), _n(F.writes.splice(0)), F.scheduled = !1, (F.reads.length || F.writes.length) && qi(t + 1)
    }
    var Ss = 4;

    function qi(t) {
        F.scheduled || (F.scheduled = !0, t && t < Ss ? b.resolve().then(function() {
            return ji(t)
    ...
    var tt = {};
    tt.events = tt.created = tt.beforeConnect = tt.connected = tt.beforeDisconnect = tt.disconnected = tt.destroy = Yi, tt.args = function(t, e) {
        return e !== !1 && Yi(e || t)
    ...
    function he(t, e, i) {
        var n = {};
        if (ct(e) && (e = e.options), e.extends && (t = he(t, e.extends, i)), e.mixins)
            for (var r = 0, s = e.mixins.length; r < s; r++) t = he(t, e.mixins[r], i);
        for (var o in t) u(o);
    ...
    function si(t, e) {
        ...
        e === void 0 && (e = []);
        try {
            return t ? vt(t, "{") ? JSON.parse(t) : e.length && !w(t, ":") ? (i = {}, i[e[0]] = t, i) : t.split(";").reduce(function(n, r) {
                var s = r.split(/:(.*)/),
                    o = s[0],
                    a = s[1];
    ...
    function ce(t, e, i) {
        return e === void 0 && (e = 0), i === void 0 && (i = 0), W(t) ? ln.apply(void 0, jt(t).map(function(n) {
            var r = B(fe(n)),
                s = r.top,
                o = r.left,
                a = r.bottom,
    ...
    function Ki(t, e) {
        ...
        return n.reduce(function(a, u, c) {
            ...
            return i > 0 && l < g + i ? T += i : i = 0, T > v ? (i -= T - v, T = v) : T < 0 && (i -= T, T = 0),
                function() {
    ...
    function Fn(t, e, i, n, r, s, o, a) {
        ...
        var c = B(t),
            f = B(e),
            h = f;
        if (Ln(h, i, c, -1), Ln(h, n, f, 1), r = Rn(r, c.width, c.height), s = Rn(s, f.width, f.height), r.x += s.x, r.y += s.y, h.left += r.x, h.top += r.y, o) {
            var l = jt(t).map(fe);
            a && !w(l, a) && l.unshift(a), l = l.map(function(v) {
                return B(v)
            }), nt(De, function(v, p) {
                var g = v[0],
                    x = v[1],
                ...
                !(o === !0 || w(o, g)) || l.some(function(L) {
                    ...
                    function Fe(Le, ki) {
                        ...
                        if (Yt >= L[x] && Yt + c[p] <= L[T]) return h[x] = Yt, ["element", "target"].forEach(function(an) {
    ...
    function As(t) {
        ...
        t.use = function(r) {
            ...
            s = (H(s) ? t.component(s) : s) || this, s.options = he(s.options, r)
        }, t.extend = function(r) {
            r = r || {};
            var s = this,
                o = function(u) {
            ...
            return o.prototype = Object.create(s.prototype), o.prototype.constructor = o, o.options = he(s.options, r), o.super = s, o.extend = s.extend, o
        }, t.update = function(r, s) {
            r = r ? J(r) : document.body, ye(r).reverse().forEach(function(o) {
                return n(o[e], s)
            }), It(r, function(o) {
                return n(o[e], s)
            })
        ...
        function e(n) {
            for (var r = this, s = this.$options.update, o = function(u) {
                    ...
                    if (!(!n.has("update") && (!l || !l.some(function(p) {
                        ...
                        var v = void 0;
                        f && (v = f.call(r, r._data, n), v && Mt(v) && S(r._data, v)), h && v !== !1 && F.write(function() {
    ...
    function Ms(t) {
        ...
        t.prototype._init = function(h) {
            h = h || {}, h.data = u(h, this.constructor.options), this.$options = he(this.constructor.options, h, this), this.$el = null, this.$props = {}, this._uid = e++, this._initData(), this._initMethods(), this._initComputeds(), this._callHook("created"), h.el && this.$mount(h.el)
            ...
            var h = this.$options,
                l = h.methods;
            if (l)
                for (var v in l) this[v] = l[v].bind(this)
        }, t.prototype._initComputeds = function() {
            var h = this.$options,
                l = h.computed;
            if (this._computeds = {}, l)
                for (var v in l) n(this, v, l[v])
        ...
        function i(h, l) {
            ...
            for (var T in g) {
                var L = Bt(T),
                    _ = ft(x, L);
                Z(_) || (_ = g[T] === Boolean && _ === "" ? !0 : o(g[T], _), !(L === "target" && (!_ || vt(_, "_"))) && (v[T] = _))
            }
            var St = si(ft(x, l), p);
            for (var ut in St) {
                var bt = Xt(ut);
        ...
        function u(h, l) {
            var v = h.data,
                p = l.args,
                g = l.props;
            if (g === void 0 && (g = {}), v = ht(v) ? Zt(p) ? void 0 : v.slice(0, p.length).reduce(function(T, L, _) {
                    return Mt(L) ? S(T, L) : T[p[_]] = L, T
                }, {}) : v, v)
                for (var x in v) Z(v[x]) ? delete v[x] : v[x] = g[x] ? o(g[x], v[x]) : v[x];
            return v
        }
    ...
    function Ns(t) {
        ...
        t.prototype.$create = function(n, r, s) {
            ...
            var r = this.$options,
                s = r.el,
                o = r.name;
            s && this._callDisconnected(), this._callHook("destroy"), !(!s || !s[e]) && (delete s[e][o], Zt(s[e]) || delete s[e], n && rt(this.$el))
        ...
        _t = {
            ...
            methods: {
                toggleElement: function(t, e, i) {
                    ...
                    return new b(function(r) {
                        return b.all(C(t).map(function(s) {
                            ...
                            if (!m(s, "before" + (o ? "show" : "hide"), [n])) return b.reject();
                ...
                isToggled: function(t) {
                    var e;
                    return t === void 0 && (t = this.$el), e = C(t), t = e[0], E(t, this.clsEnter) ? !0 : E(t, this.clsLeave) ? !1 : this.cls ? E(t, this.cls.split(" ")[0]) : W(t)
                },
                _toggle: function(t, e) {
                    if (!!t) {
                        e = Boolean(e);
                        var i;
                        this.cls ? (i = w(this.cls, " ") || e !== E(t, this.cls), i && j(t, this.cls, w(this.cls, " ") ? void 0 : e)) : (i = e === t.hidden, i && (t.hidden = !e)), O("[autofocus]", t).some(function(n) {
    ...
    function Os(t) {
        return function(e, i) {
            ...
            var n = t.animation,
                r = t.duration,
                s = t._toggle;
            return i ? (s(e, !0), xt.in(e, n[0], r, t.origin)) : xt.out(e, n[1] || n[0], r, t.origin).then(function() {
                return s(e, !1)
            })
        }
    }
    var Vn = {
        ...
        methods: {
            toggle: function(t, e) {
                ...
                !this.multiple && !w(r, n[0]) && (n = n.concat(r)), !(!this.collapsible && r.length < 2 && !xe(n, ":not(." + this.clsOpen + ")").length) && n.forEach(function(s) {
                    return i.toggleElement(s, !E(s, i.clsOpen), function(o, a) {
                        j(o, i.clsOpen, a), M($(i.$props.toggle, o), "aria-expanded", a);
                        var u = $("" + (o._wrapper ? "> * " : "") + i.content, o);
                        if (e === !1 || !i.hasTransition) {
                            ci(u, !a);
                            return
                        }
                        return o._wrapper || (o._wrapper = Ue(u, "<div" + (a ? " hidden" : "") + ">")), ci(u, !1), qn(i)(o._wrapper, a).then(function() {
    ...
    var Fs = {
        ...
        Yn = {
            ...
            connected: function() {
                this.inView && !te(this.$el, "preload") && (this.$el.preload = "none"), this.automute && Dn(this.$el)
            },
            update: {
                read: function() {
                    return zn(this.$el) ? {
    ...
    var le = {
        ...
        Q, Xn = {
            ...
            connected: function() {
                y(this.$el, this.clsDrop), this.toggle && !this.target && (this.target = this.$create("toggle", wt(this.toggle, this.$el), {
                    target: this.$el,
                    mode: this.mode
                }))
            },
            ...
            events: [{
                ...
                handler: function() {
                    var t = this;
                    Q = this, this.tracker.init(), X(this.$el, "hide", A(document, dt, function(e) {
                        var i = e.target;
            ...
            methods: {
                show: function(t, e) {
                    ...
                    if (t === void 0 && (t = this.target), e === void 0 && (e = !0), this.isToggled() && t && this.target && t !== this.target && this.hide(!1), this.target = t, this.clearTimers(), !this.isActive()) {
                        ...
                        this.container && z(this.$el) !== this.container && K(this.container, this.$el), this.showTimer = setTimeout(function() {
                ...
                hide: function(t) {
                    ...
                    this.clearTimers(), this.isDelaying = Rs(this.$el).some(function(n) {
                ...
                position: function() {
                    N(this.$el, this.clsDrop + "-stack"), j(this.$el, this.clsDrop + "-boundary", this.boundaryAlign);
    ...
    var js = {
            ...
            update: function() {
                var t = this,
                    ...
                    i = t.input;
                if (!!e) {
                    var n, r = Ni(e) ? "value" : "textContent",
                        s = e[r],
            ...
            update: {
                ...
                write: function(t) {
                    for (var e = t.columns, i = t.rows, n = 0; n < i.length; n++)
                        for (var r = 0; r < i[n].length; r++) j(i[n][r], this.margin, n !== 0), j(i[n][r], this.firstColumn, !!~e[0].indexOf(i[n][r]))
                },
                events: ["resize"]
            }
        };
    ...
    function Vs(t) {
        for (var e = [], i = 0; i < t.length; i++)
            for (var n = Jn(t[i], "left", "right"), r = 0; r < n.length; r++) e[r] = e[r] ? e[r].concat(n[r]) : n[r];
        ...
        for (var n = [
            ...
            if (!!W(s))
                for (var o = fi(s), a = n.length - 1; a >= 0; a--) {
                    ...
                    var c = void 0;
                    if (u[0].offsetParent === s.offsetParent ? c = fi(u[0]) : (o = fi(s, !0), c = fi(u[0], !0)), o[e] >= c[i] - 1 && o[e] !== c[e]) {
                        n.push([s]);
                        break
                    }
    ...
    function Zs(t) {
        ...
        return n && r && (d(t, "minHeight", ""), e = t.map(Qn), i = Math.max.apply(Math, e)), e = t.map(function(s, o) {
    ...
    var Qs = {
            ...
            update: {
                read: function(t) {
                    ...
                    if (this.expand) i = q(window) - (I(document.documentElement).height - I(this.$el).height) - n || "";
                    else {
                        ...
                        this.offsetBottom === !0 ? i += " - " + I(this.$el.nextElementSibling).height + "px" : Ct(this.offsetBottom) ? i += " - " + this.offsetBottom + "vh" : this.offsetBottom && gt(this.offsetBottom, "px") ? i += " - " + k(this.offsetBottom) + "px" : H(this.offsetBottom) && (i += " - " + I(wt(this.offsetBottom, this.$el)).height + "px"), i += (n ? " - " + n + "px" : "") + ")"
                    }
                    return {
                        minHeight: i,
                        prev: e
                ...
                write: function(t) {
                    ...
                    d(this.$el, {
                        minHeight: e
                    }), e !== i && this.$update(this.$el, "resize"), this.minHeight && k(d(this.$el, "minHeight")) < this.minHeight && d(this.$el, "minHeight", this.minHeight)
                },
                events: ["resize"]
            }
        },
        Un = {
            ...
            connected: function() {
                var t = this,
                    e;
                !this.icon && w(this.src, "#") && (e = this.src.split("#"), this.src = e[0], this.icon = e[1]), this.svg = this.getSvg().then(function(i) {
                    if (t._connected) {
                        var n = no(i, t.$el);
                        return t.svgEl && n !== t.svgEl && rt(t.svgEl), t.applyAttributes(n, i), t.$emit(), t.svgEl = n
                    }
                }, D)
            },
            disconnected: function() {
                ...
                this.svg.then(function(e) {
                    t._connected || (Mi(t.$el) && (t.$el.hidden = !1), rt(e), t.svgEl = null)
                }), this.svg = null
            },
            update: {
                read: function() {
            ...
            methods: {
                ...
                applyAttributes: function(t, e) {
                    var i = this;
                    for (var n in this.$options.props) w(this.include, n) && n in this && M(t, n, this[n]);
                    ...
                    f && !c.some(function(h) {
                        return h
                    }) && (c = f.split(" ").slice(2)), c.forEach(function(h, l) {
    ...
    function to(t, e) {
        return e && w(t, "<symbol") && (t = eo(t, e) || t), t = $(t.substr(t.indexOf("<svg"))), t && t.hasChildNodes() && t
    }
    ...
    function eo(t, e) {
        if (!li[t]) {
            li[t] = {}, tr.lastIndex = 0;
            for (var i; i = tr.exec(t);) li[t][i[3]] = '<svg xmlns="http://www.w3.org/2000/svg"' + i[1] + "svg>"
        }
        return li[t][e]
    }
    ...
    function To(t) {
        return di[t] ? (vi[t] || (vi[t] = $((di[Co(t)] || di[t]).trim())), vi[t].cloneNode(!0)) : null
    }
    ...
    var Eo = {
        ...
        connected: function() {
            ...
            qt[this.cacheKey] ? ze(this.$el, qt[this.cacheKey], this.dataSrcset, this.sizes) : this.isImg && this.width && this.height && ze(this.$el, Io(this.width, this.height, this.sizes)), this.observer = new IntersectionObserver(this.load, {
        ...
        update: {
            ...
            write: function(t) {
                if (this.dataSrcset && window.devicePixelRatio !== 1) {
                    ...
                    (e.match(/^(auto\s?)+$/) || k(e) === t.bgSize) && (t.bgSize = No(this.dataSrcset, this.sizes), d(this.$el, "backgroundSize", t.bgSize + "px"))
                }
            },
            events: ["resize"]
        },
        methods: {
            load: function(t) {
                ...
                !t.some(function(i) {
                    ...
                    return ze(e.$el, Ui(i), i.srcset, i.sizes), qt[e.cacheKey] = Ui(i), i
                }, function(i) {
    ...
    function Io(t, e, i) {
        ...
        return i && (n = Qt.ratio({
            width: t,
            height: e
        }, "width", yt(ur(i))), t = n.width, e = n.height), 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="' + t + '" height="' + e + '"></svg>'
    }
    ...
    var zo = {
            ...
            connected: function() {
                var t;
                t = yn(this.$el, '<span class="' + this.clsWrapper + '">'), this.wrapper = t[0]
            },
            disconnected: function() {
            ...
            update: {
                ...
                write: function(t) {
                    j(this.wrapper, this.clsHide, t.hide), t.changed && (t.changed = !1, M(this.wrapper, this.attrFill, new Array(t.width).join(t.fill)))
                },
                events: ["resize"]
            }
        },
        ...
        tn = {
            ...
            events: [{
                ...
                self: !0,
                handler: function(t, e) {
                    t.defaultPrevented || (t.preventDefault(), this.isToggled() === w(st, this) && this.toggle())
                }
            }, {
                name: "beforeshow",
                self: !0,
                ...
                handler: function() {
                    ...
                    Pe(window) > e.clientWidth && this.overlay && d(document.body, "overflowY", "scroll"), this.stack && d(this.$el, "zIndex", k(d(this.$el, "zIndex")) + st.length), y(e, this.clsPage), this.bgClose && X(this.$el, "hide", A(document, dt, function(i) {
                        var n = i.target;
                ...
                self: !0,
                handler: function() {
                    Ve(this.$el) || M(this.$el, "tabindex", "-1"), $(":focus", this.$el) || this.$el.focus()
                }
            }, {
                name: "hidden",
                self: !0,
                handler: function() {
                    var t = this;
                    w(st, this) && st.splice(st.indexOf(this), 1), st.length || d(document.body, "overflowY", ""), d(this.$el, "zIndex", ""), st.some(function(e) {
            ...
            methods: {
                ...
                show: function() {
                    var t = this;
                    return this.container && z(this.$el) !== this.container ? (K(this.container, this.$el), new b(function(e) {
    ...
    var Ho = {
        ...
        events: [{
            ...
            self: !0,
            handler: function() {
                E(this.panel, "uk-margin-auto-vertical") ? y(this.$el, "uk-flex") : d(this.$el, "display", "block"), q(this.$el)
            }
        }, {
            name: "hidden",
            self: !0,
        ...
        Fo = {
            ...
            computed: {
                ...
                dropbar: {
                    get: function(t) {
                        var e = t.dropbar;
                        return e ? (e = this._dropbar || wt(e, this.$el) || $("+ .uk-navbar-dropbar", this.$el), e || (this._dropbar = $("<div></div>"))) : null
                    },
                    watch: function(t) {
            ...
            events: [{
                ...
                handler: function(t) {
                    var e = t.current,
                        i = t.keyCode,
                        n = this.getActive();
                    i === Vt.DOWN && te(e, "aria-expanded") && (t.preventDefault(), !n || n.target !== e ? (e.click(), X(this.dropContainer, "show", function(r) {
                        var s = r.target;
                        return vr(s)
                    })) : vr(n.$el)), dr(t, this.toggles, n)
                }
            }, {
                name: "keydown",
                el: function() {
                ...
                handler: function(t) {
                    ...
                    if (!!w(this.dropdowns, e)) {
                        ...
                        i === Vt.UP && (t.preventDefault(), s > 0 && r[s - 1].focus()), i === Vt.DOWN && (t.preventDefault(), s < r.length - 1 && r[s + 1].focus()), i === Vt.ESC && n && n.target && n.target.focus(), dr(t, this.toggles, n)
                    }
                }
            }, {
                name: "mouseleave",
                ...
                handler: function(t, e) {
                    var i = e.$el,
                        n = e.dir;
                    !E(i, this.clsDrop) || (this.dropbarMode === "slide" && y(this.dropbar, "uk-navbar-dropbar-slide"), this.clsDrop && y(i, this.clsDrop + "-dropbar"), n === "bottom" && this.transitionTo(i.offsetHeight + k(d(i, "marginTop")) + k(d(i, "marginBottom")), i))
                }
            }, {
                name: "beforehide",
                el: function() {
            ...
            methods: {
                ...
                transitionTo: function(t, e) {
                    var i = this,
                        ...
                        r = n.dropbar,
                        s = W(r) ? q(r) : 0;
                    return e = s < t && e, d(e, "clip", "rect(0," + e.offsetWidth + "px," + s + "px,0)"), q(r, s), P.cancel([e, r]), b.all([P.start(r, {
                        height: t
    ...
    var Vt = {
        ...
        Lo = {
            ...
            events: [{
                ...
                self: !0,
                handler: function() {
                    this.mode === "reveal" && !E(z(this.panel), this.clsMode) && (Ue(this.panel, "<div>"), y(z(this.panel), this.clsMode)), d(document.documentElement, "overflowY", this.overlay ? "hidden" : ""), y(document.body, this.clsContainer, this.clsFlip), d(document.body, "touch-action", "pan-y pinch-zoom"), d(this.$el, "display", "block"), y(this.$el, this.clsOverlay), y(this.panel, this.clsSidebarAnimation, this.mode !== "reveal" ? this.clsMode : ""), q(document.body), y(document.body, this.clsContainerAnimation), this.clsContainerAnimation && Wo()
                }
            }, {
                name: "hide",
                self: !0,
                handler: function() {
                    N(document.body, this.clsContainerAnimation), d(document.body, "touch-action", "")
                }
            }, {
                name: "hidden",
                self: !0,
                handler: function() {
                    this.clsContainerAnimation && Ro(), this.mode === "reveal" && ti(this.panel), N(this.panel, this.clsSidebarAnimation, this.clsMode), N(this.$el, this.clsOverlay), d(this.$el, "display", ""), N(document.body, this.clsContainer, this.clsFlip), d(document.documentElement, "overflowY", "")
                }
            }, {
    ...
    var jo = {
        ...
        Vo = {
            ...
            methods: {
                scrollTo: function(t) {
                    var e = this;
                    t = t && $(t) || document.body, m(this.$el, "beforescroll", [this, t]) && Ki(t, {
                        offset: this.offset
                    }).then(function() {
            ...
            events: {
                click: function(t) {
                    t.defaultPrevented || (t.preventDefault(), this.scrollTo("#" + Te(decodeURIComponent((this.$el.hash || "").substr(1)))))
                }
            }
        },
        Ht = "_ukScrollspy",
        Yo = {
            ...
            update: [{
                read: function(t) {
                    var e = this;
                    if (!t.update) return b.resolve().then(function() {
                        e.$emit(), t.update = !0
                    }), !1;
                ...
                write: function(t) {
                    ...
                    this.elements.forEach(function(i) {
                        var n = i[Ht];
                        n.show && !n.inview && !n.queued ? (n.queued = !0, t.promise = (t.promise || b.resolve()).then(function() {
                            return new b(function(r) {
            ...
            methods: {
                toggle: function(t, e) {
                    var i = t[Ht];
                    i.off && i.off(), d(t, "visibility", !e && this.hidden ? "hidden" : ""), j(t, this.inViewClass, e), j(t, i.cls), /\buk-animation-/.test(i.cls) && (i.off = X(t, "animationcancel animationend", function() {
            ...
            update: [{
                read: function() {
                    ...
                    return s === a ? u = i - 1 : (this.targets.every(function(c, f) {
                        if (B(c).top - B(fe(r)).top - t.offset <= 0) return u = f, !0
                ...
                write: function(t) {
                    ...
                    this.links.forEach(function(n) {
                        return n.blur()
                    }), N(this.elements, this.cls), y(this.elements[e], this.cls), i && m(this.$el, "active", [e, this.elements[e]])
                },
                events: ["scroll", "resize"]
            }]
        },
        Xo = {
            ...
            computed: {
                ...
                isActive: {
                    ...
                    set: function(t) {
                        t && !this.isActive ? (Bi(this.selTarget, this.clsInactive, this.clsActive), m(this.$el, "active")) : !t && !E(this.selTarget, this.clsInactive) && (Bi(this.selTarget, this.clsActive, this.clsInactive), m(this.$el, "inactive"))
                    }
                }
            },
            connected: function() {
            ...
            disconnected: function() {
                this.isFixed && (this.hide(), N(this.selTarget, this.clsInactive)), rt(this.placeholder), this.placeholder = null, this.widthElement = null
            },
            events: [{
            ...
            update: [{
                read: function(t, e) {
                    ...
                    this.isActive && e.has("resize") && (this.hide(), i = this.$el.offsetHeight, this.show()), i = this.isActive ? i : this.$el.offsetHeight;
                    ...
                    return this.top = Math.max(k(pr("top", this)), this.topOffset) - this.offset, this.bottom = r && r - this.$el.offsetHeight, this.width = I(W(this.widthElement) ? this.widthElement : this.$el).width, {
                        height: i,
                ...
                write: function(t) {
                    ...
                    d(r, S({
                        height: e
                    }, i)), G(r, document) || (Ze(this.$el, r), r.hidden = !0), this.isActive = !!this.isActive
                },
                events: ["resize"]
            }, {
                read: function(t) {
                ...
                write: function(t, e) {
                    ...
                    if (t.lastScroll = c, !(c < 0 || c === u && r || this.showOnUp && !r && !this.isFixed) && ((n - s > 300 || o !== a) && (t.initScroll = c, t.initTimestamp = n), t.lastDir = o, !(this.showOnUp && !this.isFixed && Math.abs(t.initScroll - c) <= 30 && Math.abs(u - c) <= 10)))
                        if (this.inactive || c < this.top || this.showOnUp && (c <= this.top || o === "down" && r || o === "up" && !this.isFixed && c <= this.bottomOffset)) {
                            if (!this.isFixed) {
                                xt.inProgress(this.$el) && f > c && (xt.cancel(this.$el), this.hide());
                                return
                            }
                            this.isFixed = !1, this.animation && c > this.topOffset ? (xt.cancel(this.$el), xt.out(this.$el, this.animation).then(function() {
                                return i.hide()
                            }, D)) : this.hide()
                        } else this.isFixed ? this.update() : this.animation ? (xt.cancel(this.$el), this.show(), xt.in(this.$el, this.animation).catch(D)) : this.show()
                },
                events: ["resize", "scroll"]
            }],
            methods: {
                ...
                hide: function() {
                    this.isActive = !1, N(this.$el, this.clsFixed, this.clsBelow), d(this.$el, {
                        position: "",
                        top: "",
                        width: ""
                ...
                update: function() {
                    var t = this.top !== 0 || this.scroll > this.top,
                        ...
                        i = "fixed";
                    Ct(this.bottom) && this.scroll > this.bottom - this.offset && (e = this.bottom - this.offsetParentTop, i = "absolute"), d(this.$el, {
                        position: i,
                        top: e + "px",
                        width: this.width
    ...
    function pr(t, e) {
        var i = e.$props,
            ...
            r = e[t + "Offset"],
            s = i[t];
        if (!!s) return H(s) && s.match(/^-?\d/) ? r + yt(s) : B(s === !0 ? z(n) : wt(s, n)).bottom
    }
    var mr = {
            mixins: [_t],
            args: "connect",
        ...
        Jo = {
            ...
            events: [{
                ...
                handler: function(t) {
                    var e = this;
                    !Et(t) || this._showState || (m(this.$el, "focus"), X(document, dt, function() {
                        return m(e.$el, "blur")
                    }, !0, function(i) {
                ...
                handler: function(t) {
                    ...
                    var e;
                    (ot(t.target, 'a[href="#"], a[href=""]') || (e = ot(t.target, "a[href]")) && (M(this.$el, "aria-expanded") !== "true" || e.hash && Y(this.target, e.hash))) && t.preventDefault(), this.toggle()
                }
            }, {
                name: "toggled",
                self: !0,
    ...
    function wr(t, e, i, n) {
        ...
        var r = pi(e, !0),
            ...
            u = a(function() {
                return y(e, en), b.all($r(e).map(function(f, h) {
                ...
                return y(e, nn), t(), d(R(e), {
                    ...
                    return requestAnimationFrame(function() {
                        ...
                        f !== v && g.push(P.start(e, {
                            height: v
                        }, i / 2 + p.length * n, "ease")), b.all(g).then(function() {
                            N(e, nn), r === pi(e) && (d(e, {
                                height: "",
                                alignContent: ""
                            }), d(l, {
    ...
    function pi(t, e) {
        return e && (t.dataset.transition = 1 + pi(t)), Nt(t.dataset.transition) || 0
    }
    ...
    function ta(t, e, i) {
        return new b(function(n) {
            return requestAnimationFrame(function() {
                ...
                P.cancel(e), r.forEach(P.cancel), yr(e), t(), r = r.concat(R(e).filter(function(a) {
                    return !w(r, a)
    ...
    function Cr(t, e, i) {
        var n = Tr(t, e),
            ...
            o = n.sort,
            a = n.order;
        return a === void 0 && (a = "asc"), (r || Z(o)) && (s ? r ? (delete i.filter[""], i.filter[s] = r) : (delete i.filter[s], (Zt(i.filter) || "" in i.filter) && (i.filter = {
            "": r || ""
        })) : i.filter = {
            "": r || ""
        }), Z(o) || (i.sort = [o, a]), i
    ...
    function sa(t, e, i) {
        ...
        var f = a.sort,
            h = a.order;
        return h === void 0 && (h = "asc"), Z(f) ? c in n && u === n[c] || !u && c && !(c in n) && !n[""] : s === f && o === h
    }
    ...
    function V(t, e) {
        return t === void 0 && (t = 0), e === void 0 && (e = "%"), t += t ? e : "", be ? "translateX(" + t + ")" : "translate3d(" + t + ", 0, 0)"
    }
    ...
    function ha(t, e, i, n) {
        ...
        return {
            ...
            show: function(h, l, v) {
                ...
                l === void 0 && (l = 0);
                var g = v ? "linear" : s;
                return h -= Math.round(h * pt(l, -1, 1)), this.translate(l), mi(e, "itemin", {
                    percent: l,
                    duration: h,
                    timing: g,
                    dir: i
            ...
            forward: function(h, l) {
                return l === void 0 && (l = this.percent()), P.cancel([e, t]), this.show(h, l, !0)
            },
            translate: function(h) {
                this.reset();
                var l = a(h, i);
                d(e, l[1]), d(t, l[0]), mi(e, "itemtranslatein", {
                    percent: h,
                    dir: i
    ...
    var ca = {
        ...
        fa = {
            ...
            methods: {
                start: function() {
                    this.drag = this.pos, this._transitioner ? (this.percent = this._transitioner.percent(), this.drag += this._transitioner.getDistance() * this.percent * this.dir, this._transitioner.cancel(), this._transitioner.translate(this.percent), this.dragging = !0, this.stack = []) : this.prevIndex = this.index, A(document, ne, this.move, {
                        passive: !1
                    }), A(document, $t + " " + se + " input", this.end, !0), d(this.list, "userSelect", "none")
                },
                move: function(t) {
                    var e = this,
                    ...
                    if (!(i === 0 || this.prevPos === this.pos || !this.dragging && Math.abs(i) < this.threshold)) {
                        ...
                        }), (this.index === o && this.prevIndex !== o || p) && m(r[this.index], "itemshown", [this]), l && (this.prevIndex = o, this.index = u, !v && m(f, "beforeitemhide", [this]), m(h, "beforeitemshow", [this])), this._transitioner = this._translate(Math.abs(this.percent), f, !v && h), l && (!v && m(f, "itemhide", [this]), m(h, "itemshow", [this]))
                    }
                },
                end: function() {
                    if (Wt(document, ne, this.move, {
                            passive: !1
                        }), Wt(document, $t + " " + se + " input", this.end, !0), this.dragging)
            ...
            methods: {
                show: function(t, e) {
                    ...
                    if (e === void 0 && (e = !1), !(this.dragging || !this.length)) {
                        ...
                        if (this.dir = va(t, a), this.prevIndex = a, this.index = c, u && !m(u, "beforeitemhide", [this]) || !m(f, "beforeitemshow", [this, u])) {
                            this.index = this.prevIndex, o();
                            return
                        }
                        var h = this._show(u, f, e).then(function() {
                            return u && m(u, "itemhidden", [i]), m(f, "itemshown", [i]), new b(function(l) {
                                F.write(function() {
                                    r.shift(), r.length ? i.show(r.shift(), !0) : i._transitioner = null, l()
                                })
                            })
                        });
                ...
                getIndex: function(t, e) {
                    return t === void 0 && (t = this.index), e === void 0 && (e = this.index), pt(Ut(t, this.slides, e, this.finite), 0, this.maxIndex)
                },
                ...
                _show: function(t, e, i) {
                    if (this._transitioner = this._getTransitioner(t, e, this.dir, S({
                        ...
                        }, this.transitionOptions)), !i && !t) return this._translate(1), b.resolve();
                    var n = this.stack,
                        r = n.length;
                ...
                _getTransitioner: function(t, e, i, n) {
                    return t === void 0 && (t = this.prevIndex), e === void 0 && (e = this.index), i === void 0 && (i = this.dir || 1), n === void 0 && (n = this.transitionOptions), new this.Transitioner(Jt(t) ? this.slides[t] : t, Jt(e) ? this.slides[e] : e, i * (U ? -1 : 1), n)
                }
            }
        };
    ...
    var Ar = {
        ...
        Pr = {
            ...
            events: [{
                ...
                self: !0,
                handler: function() {
                    this.hideControls(), N(this.slides, this.clsActive), P.stop(this.slides)
                }
            }, {
                name: "hidden",
                self: !0,
                ...
                name: "beforeitemshow",
                handler: function(t) {
                    this.isToggled() || (this.draggable = !1, t.preventDefault(), this.toggleElement(this.$el, !0, !1), this.animation = Er.scale, N(t.target, this.clsActive), this.stack.splice(1, 0, this.index))
                }
            }, {
                name: "itemshow",
                handler: function() {
                ...
                handler: function(t, e) {
                    ...
                    if (a === void 0 && (a = {}), this.setItem(e, "<span uk-spinner></span>"), !!n) {
                        ...
                        if (r === "image" || n.match(/\.(avif|jpe?g|a?png|gif|svg|webp)($|\?)/i)) zi(n, a.srcset, a.size).then(function(h) {
                            var l = h.width,
                                v = h.height;
                        ...
                        } else r === "iframe" || n.match(/\.(html|php)($|\?)/i) ? this.setItem(e, Be("iframe", S({
                            src: n,
                            frameborder: "0",
                            allowfullscreen: "",
    ...
    function pa(t, e) {
        t.lightboxPanel || t.component("lightboxPanel", Pr), S(e.props, t.component("lightboxPanel").options.props)
    }
                ...
                props: function(t, e) {
                    ...
                    return sn.reduce(function(n, r) {
                        ...
                        var s = r.match(/color/i),
                            o = s || r === "opacity",
                            a, u, c, f = t[r].slice();
                        o && d(e, r, ""), f.length < 2 && f.unshift((r === "scale" ? 1 : o ? d(e, r) : 0) || 0);
                        var h = xa(f);
                        if (s) {
                            var l = e.style,
                                v = l.color;
                            ...
                            if (f = f.map(function(_) {
                                    return yt(_, p, i.$el)
                                }), d(e, "background-position-" + r[2], ""), u = d(e, "backgroundPosition").split(" ")[r[2] === "x" ? 0 : 1], i.covers) {
                                var g = Math.min.apply(Math, f),
                                    x = Math.max.apply(Math, f),
                                    T = f.indexOf(g) < f.indexOf(x);
                                c = x - g, f = f.map(function(_) {
                                    return _ - (T ? g : x)
                                }), a = (T ? -c : 0) + "px"
                            } else a = u
                        } else f = f.map(k);
                        if (r === "stroke") {
                            ...
                            var L = er(i.$el);
                            d(e, "strokeDasharray", L), h === "%" && (f = f.map(function(_) {
                                return _ * L / 100
                            })), f = f.reverse(), r = "strokeDashoffset"
                        }
                        return n[r] = {
                            steps: f,
                            unit: h,
                            ...
                            case "borderColor":
                                {
                                    var f = Dr(o, t),
                                        h = f[0],
                                        l = f[1],
                                        v = f[2];n[r] = "rgba(" + h.map(function(p, g) {
                                        return p = p + v * (l[g] - p), g === 3 ? k(p) : parseInt(p, 10)
                                    }).join(",") + ")";
                                    break
                                }
                            case "blur":
                                ...
                                break;
                            case "hue":
                                a = a || "deg", n.filter += " hue-rotate(" + (c + a) + ")";
                                break;
                            case "fopacity":
    ...
    function Ta(t, e, i, n) {
        ...
        return {
            ...
            show: function(f, h, l) {
                h === void 0 && (h = 0);
                var v = l ? "linear" : s;
                return f -= Math.round(f * pt(h, -1, 1)), this.translate(h), h = t ? h : pt(h, 0, 1), on(this.getItemIn(), "itemin", {
                    percent: h,
                    duration: f,
                    timing: v,
                    dir: i
                ...
                }, f, v).then(a.resolve, D), a.promise
            },
            cancel: function() {
                P.cancel(o)
            },
            ...
            forward: function(f, h) {
                return h === void 0 && (h = this.percent()), P.cancel(o), this.show(f, h, !0)
            },
            translate: function(f) {
                ...
                var l = this.getActives(),
                    v = this.getItemIn(),
                    p = this.getItemIn(!0);
                f = t ? pt(f, -1, 1) : 0, R(o).forEach(function(g) {
                    var x = w(l, g),
                        T = g === v,
                        L = g === p,
    ...
    var Ea = {
            ...
            sets: function(t) {
                ...
                if (!!i) {
                    ...
                    return i = we(this.slides, "offsetLeft").reduce(function(a, u, c) {
                        var f = I(u).width,
                            h = o + f;
                        if (h > r && (!e.center && c > e.maxIndex && (c = e.maxIndex), !w(a, c))) {
                            var l = e.slides[c + 1];
                            e.center && l && f < s - I(l).width / 2 ? s -= f : (s = n, a.push(c), r = o + n + (e.center ? f / 2 : 0))
                        }
                        return o += f, a
                    }, []), !Zt(i) && i
                }
        ...
        events: {
            beforeitemshow: function(t) {
                ...
                this.duration = _r(this.avgWidth / this.velocity) * (I(this.slides[n]).width / this.avgWidth), this.reorder()
            },
            itemshow: function() {
                        ...
                        if (!!c) {
                            ...
                            if (!f.some(P.inProgress)) {
                                ...
                                if (!(f.length && (!h || h === u))) {
                                    ...
                                    v !== !1 && (v && u === v || (c !== l ? (l.remove(u), t.moved = h) : delete t.moved, c.insert(u, v), this.touched.add(c)))
                                }
                            }
                        }
                    }
            ...
            methods: {
                init: function(t) {
                    var e = t.target,
                        ...
                        s = r[0];
                    !s || n || i > 0 || Ni(e) || G(e, "." + this.clsNoDrag) || this.handle && !G(e, this.handle) || (t.preventDefault(), this.touched = new Set([this]), this.placeholder = s, this.origin = S({
                        target: e,
                        index: oe(s)
                    }, this.pos), A(document, ne, this.move), A(document, $t, this.end), this.threshold || this.start(t))
                },
                start: function(t) {
                    ...
                    }), y(this.drag, this.clsDrag, this.clsCustom), y(this.placeholder, this.clsPlaceholder), y(this.items, this.clsItem), y(document.documentElement, this.clsDragState), m(this.$el, "start", [this, this.placeholder]), Ma(this.pos), this.move(t)
                },
                move: function(t) {
                    ...
                    var t = this;
                    if (Wt(document, ne, this.move), Wt(document, $t, this.end), Wt(window, "scroll", this.scroll), !!this.drag) {
                        Na();
                        var e = this.getSortable(this.placeholder);
                        this === e ? this.origin.index !== oe(this.placeholder) && m(this.$el, "moved", [this, this.placeholder]) : (m(e.$el, "added", [e, this.placeholder]), m(this.$el, "removed", [this, this.placeholder])), m(this.$el, "stop", [this, this.placeholder]), rt(this.drag), this.drag = null, this.touched.forEach(function(i) {
    ...
    function Ma(t) {
        ...
        Rr = setInterval(function() {
            ...
            var r = (Date.now() - e) * .3;
            e = Date.now(), jt(document.elementFromPoint(i, t.y)).reverse().some(function(s) {
                var o = s.scrollTop,
                    a = s.scrollHeight,
                    u = B(fe(s)),
                    c = u.top,
    ...
    function Da(t, e) {
        ...
        return d(i, "margin", "0", "important"), d(i, S({
    ...
    var xi, Oa = {
        ...
        beforeConnect: function() {
            this._hasTitle = te(this.$el, "title"), M(this.$el, "title", ""), this.updateAria(!1), Fa(this.$el)
        },
        disconnected: function() {
        ...
        methods: {
            ...
            _show: function() {
                var t = this;
                this.tooltip = K(this.container, '<div class="' + this.clsPos + '"> <div class="' + this.clsPos + '-inner">' + this.title + "</div> </div>"), A(this.tooltip, "toggled", function(e, i) {
                    t.updateAria(i), !!i && (t.positionAt(t.tooltip, t.$el), t.origin = t.getAxis() === "y" ? Me(t.dir) + "-" + t.align : t.align + "-" + Me(t.dir))
                        ...
                        r = function(s) {
                            ...
                            Je(e.url, {
                                ...
                                beforeSend: function(u) {
                                    var c = u.xhr;
                                    return c.upload && A(c.upload, "progress", e.progress), ["loadStart", "load", "loadEnd", "abort"].forEach(function(f) {
