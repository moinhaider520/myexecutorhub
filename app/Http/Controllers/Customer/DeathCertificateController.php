...
class DeathCertificateController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('customer.death_certificates.index', compact('verifications'));
    }
    ...
    public function store(Request $request, DeathCertificateWorkflowService $workflowService)
    {
        ...
        try {
            ...
            return redirect()
                ->route('customer.death_certificates.index')
    ...
    {
        abort_if($verification->customer_id !== Auth::id(), 403);
