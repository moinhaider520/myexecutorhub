...
class FuneralPlanController extends Controller
{
    ...
    public function view()
    {
        ...
        return view('customer.funeral_plans.view', compact('funeralPlans', 'funeralPlanTypes'));
    }
    ...
    public function destroy(string $id)
    {
        try {
            ...
            DB::commit();
            return redirect()->route('customer.funeral_plans.view')->with('success', 'Funeral plan deleted successfully.');
        } catch (\Exception $e) {
            DB::rollback();
