...
class OtherTypeofAssetController extends Controller
{
    public function view()
    {
        ...
        return view('customer.assets.other_type_of_assets', compact('otherAssets', 'otherAssetTypes'));
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            $otherAsset->delete();
            DB::commit();
            return redirect()->route('customer.other_type_of_assets.view')->with('success', 'Other Asset deleted successfully.');
        } catch (\Exception $e) {
            DB::rollback();
