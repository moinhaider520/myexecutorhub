...
class WillController extends Controller
{
    public function index()
    {
        ...
        return view('customer.wills.index', compact('wills'));
    }

    public function create()
    {
        $authId = auth()->id();
        return view('customer.wills.create', ['authId' => $authId]);
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            $willVideo->delete();
            DB::commit();
            return redirect()->route('customer.wills.index')->with('success', 'Will deleted successfully.');
        } catch (\Exception $e) {
            DB::rollback();
