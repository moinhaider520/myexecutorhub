...
class BusinessInterestController extends Controller
{
    public function view()
    {
        ...
        return view('partner.assets.business_interest', compact('businessInterests', 'businessTypes'));
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            DB::commit();
            return redirect()->route('partner.business_interest.view')->with('success', 'Business interest deleted successfully.');
        } catch (\Exception $e) {
            DB::rollback();
