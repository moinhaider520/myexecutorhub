...
class PermissionController extends Controller
{
    public function showAssignPermissionsForm(Request $request)
    {
        ...
        return view('partner.assign_permissions', compact('roles', 'permissions', 'assignedPermissions'));
    }
    ...
    public function assignPermissions(Request $request)
    {
        ...
        return redirect()->route('partner.assign_permissions_form', ['role' => $request->role])->with('success', 'Permissions assigned successfully!');
    }
}
