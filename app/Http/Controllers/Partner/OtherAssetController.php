...
class OtherAssetController extends Controller
{
    public function view()
    {
        ...
        return view('partner.assets.other_assets', compact('otherAssets', 'otherAssetTypes'));
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            $otherAsset->delete();
            DB::commit();
            return redirect()->route('partner.other_assets.view')->with('success', 'Other Asset deleted successfully.');
        } catch (\Exception $e) {
            DB::rollback();
