...
class OrgansDonationController extends Controller
{
    public function view()
    {
        ...
        return view('partner.donations.organs_donation', compact('organ_donations'));
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            $digitalAsset->delete();
            DB::commit();
            return redirect()->route('partner.organ_donations.view')->with('success', 'Organ Donation deleted successfully.');
