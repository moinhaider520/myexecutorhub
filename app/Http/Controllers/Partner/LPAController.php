...
class LPAController extends Controller
{
    ...
    {      
        ...
        return view('partner.lpa.index',compact('lpas'));
    }

    public function create()
    {      
        $authId = auth()->id();
        return view('partner.lpa.create', ['authId' => $authId]);
    }
...
try {
    ...
    public function destroy($id)
    {
        try {
            ...
            $lpaVideo->delete();
            DB::commit();
            return redirect()->route('partner.lpa.index')->with('success', 'LPA deleted successfully.');
