...
class DebtAndLiabilityController extends Controller
{
    public function view()
    {
        ...
        return view('partner.assets.debt_and_liabilities', compact('debtsLiabilities', 'debtandliabilitiesTypes'));
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            DB::commit();
            return redirect()->route('partner.debt_and_liabilities.view')->with('success', 'Debt & Liability deleted successfully.');
        } catch (\Exception $e) {
            DB::rollback();
