...
class InsurancePolicyController extends Controller
{
    public function view()
    {
        ...
        return view('partner.assets.insurance_policies', compact('insurancePolicies', 'insuranceTypes'));
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            DB::commit();
            return redirect()->route('partner.insurance_policies.view')->with('success', 'Insurance policy deleted successfully.');
