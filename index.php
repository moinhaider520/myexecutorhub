                    ...
                    <div>
                        <div>
                            <a class="logo" href="index.php">
                                <img class="img-fluid for-light" src="assets/images/logo/logomain.png" alt="looginpage"
                                    style="width:200px;">
                                <img class="img-fluid for-dark" src="assets/images/logo/logomain.png" alt="looginpage"
                                    style="width:200px;">
                            </a>
                        </div>
